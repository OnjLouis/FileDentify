...
namespace FileDentify
{
    internal static class ManualService
    {
        ...
        private static void SupportedFileTypes(StringBuilder html)
        {
            ...
            SupportedRow(html, "Sample and instrument banks", ".sf2, .sbk, .sfArk, .dls, .ecw, .sfz, .exs, .ufs, .blob, .jlw, .vop, Ensoniq .efe/.eda/.edt", "Bank metadata, visible preset/instrument/sample names, container hints, legacy sound-bank clues, Ensoniq EPS/ASR/TS header/catalog strings, and proprietary payload notes.");
