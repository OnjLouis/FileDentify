...
namespace FileDentify
{
    internal static partial class ManualService
    {
        ...
        private static void SupportedFileTypes(StringBuilder html)
        {
            ...
            SupportedRow(html, "Mac and Apple packages", ".logicx, .logic, .band, .garageband, Logic Pro Library.bundle, .sparsebundle, .DS_Store, iPhone/iPad backup folders, extensionless iOS backup payloads, .app, .framework, .bundle, .plugin, .appex, .xpc, .kext, .prefPane, .storyboardc, .momd, .rtfd, .component, .vst, .vst3, .clap, .aaxplugin, .ipa, .ipsw, .pkg, .car, .strings, .nib, .metallib, .sdef, .scpt, .kmmacros, .entitlements, .xcprivacy, .mobileconfig", "Package-folder identity, Info.plist fields, Finder folder metadata, project metadata, Logic library package structure, sparse-bundle details, mobile-backup manifests and hashed stored-file layout, app/archive structure, compiled UI/resource packages, compiled AppleScript identity, Keyboard Maestro macro structure/privacy guidance, scripting/privacy/entitlement files, and Apple resource hints.");
        ...
        private static void ReportSections(StringBuilder html)
        {
            ...
            Row(html, "Firmware / device image", "PC BIOS/UEFI firmware, Android boot images, U-Boot legacy uImage files, UF2 microcontroller firmware, Broadcom/OpenWrt TRX router firmware, flattened device tree blobs, Intel HEX, Motorola S-records, Synology DSM/SRM PAT update packages, Orbit Reader 20 Plus firmware, Roland expansion data, file size, visible firmware strings, header and version fields, compatibility guidance, record summaries, and a clear no-flash/no-modify note.");
