...
namespace FileDentify
{
    internal static partial class ManualService
    {
        ...
        private static void SupportedFileTypes(StringBuilder html)
        {
            ...
            SupportedRow(html, "Windows system data", ".evtx, .etl, .wer, .dmp/.mdmp minidumps, .pnf, .inf_loc, .gpd, .gdl, .mof, .mfl, .cdxml, .psd1, .psm1, .ps1xml, .xrm-ms, .sdb, catdb, .cat, .appx, .msix, .msixbundle, .manifest, .man, .msc, .mui, .mun, .winmd, .xbf, .pri, .nls, .ttc, .fon, .acm, .ax, .grxml, .wprp, .ppkg, .provxml, .devicemetadata-ms, .cip, .ppd, .regtrans-ms, .blf, .mo, .qm, .tlb, boot.sdi/.sdi, hosts, services, protocol, networks", "Event-log and trace-log headers, WER report fields, minidump header/stream counts and privacy notes, driver setup cache and localization clues, printer description directives, WMI and PowerShell structure counts, licensing XML counts, app compatibility database markers, catalog database markers, Windows app package manifest/signature presence, instrumentation manifest counts, MUI/MUN resource clues, WinRT/XAML/resource index hints, font collection counts, device/provisioning metadata roles, translation-catalog counts, COM type-library markers, boot SDI image hints, and network-config entries.");
            SupportedRow(html, "Documents, ebooks, and data documents", ".pdf, .docx, .xlsx, .pptx, .odt, .ods, .odp, .rtf, .fodt, .epub, .lit, .mobi, .prc, .pdb, .lrf, .brf, .cbr, .cbz, .chm, .hlp, .hhc, .fits", "Document metadata, ZIP/package structure, creator/date fields, counts, embedded media/resource clues, RTF header fields and safe text preview, legacy ebook headers, Palm/MOBI database fields, braille text previews, comic archive hints, compiled help headers, HTML Help contents sidecars, and FITS scientific header cards.");
            ...
            SupportedRow(html, "Music projects and presets", ".als, .ablbundle, .abl, .ablpreset, .asd, .rpp, .rpp-bak, .reaperthemezip, .ptx, WaveCache.wfm, .spn, .cpr, .npr, .all, .arr, .lso, .undo inside Logic packages, Logic Pro Library.bundle resources such as .cst/.acp/.aaz/.pst/.zxml/.ubs/.sdir_1, .sxt, .chtr, .nac, .nov, .h0, .hdp, .ovm, .akp, .akm, .rbm, .mdd, .fxp, .fxb, .vstpreset, .wrk, .cwp, .logikcs, .loopparam, .progindex, .jgl, .fxl, .fsl, Yamaha S-YXG .tbl files, .mod, .xm, .s3m, .it, .mogg, .syx, QWS .ini/.lng support files", "Project/preset identity, visible names, tracker details, SysEx clues, DAW-specific markers, Ableton analysis sidecars, Pro Tools session/cache sidecars, Logic key-command, library, patch, preset, and undo sidecars, REAPER project/theme packages, Reason NN-XT, GarageBand chord data, Native Instruments sample-add sidecars, MAGIX/SEK'D metadata, Akai sampler programs/multis, ReBirth mods, GN Audio embedded-MIDI containers, iKaossilator project/index sidecars, Roland Juno-G and Fantom Librarian data, Yamaha S-YXG table roles, and QWS instrument-map/transform/settings summaries.");
            ...
            SupportedRow(html, "Mac and Apple packages", ".logicx, .logic, .band, .garageband, Logic Pro Library.bundle, .sparsebundle, .DS_Store, iPhone/iPad backup folders, extensionless iOS backup payloads, .app, .framework, .bundle, .plugin, .appex, .xpc, .kext, .prefPane, .storyboardc, .momd, .rtfd, .component, .vst, .vst3, .clap, .aaxplugin, .ipa, .ipsw, .pkg, .car, .strings, .nib, .metallib, .sdef, .entitlements, .xcprivacy, .mobileconfig", "Package-folder identity, Info.plist fields, Finder folder metadata, project metadata, Logic library package structure, sparse-bundle details, mobile-backup manifests and hashed stored-file layout, app/archive structure, compiled UI/resource packages, scripting/privacy/entitlement files, and Apple resource hints.");
            ...
            SupportedRow(html, "Personal data exports", ".vmg, .vcf, .ics, .opml, .eml, .wme, .wpl, .m3u, .m3u8", "Nokia/Symbian message structure, vCard/contact counts, calendar/reminder counts, OPML subscription counts, email headers/MIME hints, Windows Media Encoder session fields, Windows Media Player and M3U/M3U8 playlist entries, and privacy notes.");
